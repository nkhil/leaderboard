...
export function createHash(str) {
  console.log('🚀 ~ file: apiKey.js ~ line 20 ~ createHash ~ str', str)
  var salt = generateSalt(SALT_LENGTH)
  console.log('🚀 ~ file: apiKey.js ~ line 22 ~ createHash ~ salt', salt)
  var hash = md5(str + salt)
  console.log('🚀 ~ file: apiKey.js ~ line 24 ~ createHash ~ hash', hash)
  return salt + hash;
}
